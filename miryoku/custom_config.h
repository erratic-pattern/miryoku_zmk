...
U_MT(GUI, A),      U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    U_MT(HYPER, G),    U_MT(HYPER, H),    U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SEMI),   \
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp HYPER,         &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
U_NA,              &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP

#define MIRYOKU_LAYER_MOUSE \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp HYPER,         U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              \
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp HYPER,         &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,          \
...
&kp SQT,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         &kp HYPER,         &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
...
&kp DQT,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          &kp HYPER,         &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NU,              &kp HYPER,         &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
